...
class PipelinePlanner:
    ...
    def evaluatePipeline(self, point, button):
        if button == Qt.LeftButton:
            ...
            # Eagles
            lyrEaggle = QgsProject.instance().mapLayersByName("BAEA Buffer")[0]
            eagles = lyrEaggle.getFeatures(pipeline.boundingBox())
            for eagle in eagles:
            ...
            for buowl in buowls:
                ...
                valDistance = pipeline.distance(buowl.geometry().centroid().buffer(-0.001, 5))
